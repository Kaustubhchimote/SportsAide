...
/* @figmaId 2:2977 */
export const Football: FC<Props> = memo(function Football(props = {}) {
  return (
    <div className={`${resets.clapyResets} ${classes.root}`}>
      ...
      <div className={classes.welcomeToTheAllYouNeedToKnowAb}>
        Welcome to the all you need to know about Football!
      </div>
      ...
      <div className={classes.ourVeryOwnFootballTournamentIn}>
        Our very own football tournament in which 10 teams can participate. They
        would each play 2 matches against their opponents and the two table
        toppers would then fight out for the WIN
      </div>
      <div className={classes.footballTournament}>Football Tournament </div>
      <div className={classes.partneredTeams}>Partnered Teams</div>
      <div className={classes.rectangle262}></div>
      <div className={classes.speedFeathers}>Speed Feathers</div>
      <div className={classes.first}>First</div>
      <div className={classes.bill1}></div>
      <div className={classes.rectangle272}></div>
      <div className={classes.blueRayMasters}>Blue Ray Masters</div>
      <div className={classes.second}>Second</div>
      <div className={classes.beverly1}></div>
      <div className={classes.rectangle282}></div>
      <div className={classes.eagles}>Eagles</div>
      <div className={classes.third}>Third</div>
      <div className={classes.claudia1}></div>
      <div className={classes.rectangle29}></div>
      <div className={classes.spokaneShockers}>Spokane Shockers</div>
